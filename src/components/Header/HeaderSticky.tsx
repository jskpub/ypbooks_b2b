    ...
    <div className={`header-sticky${isSticky ? ' is-visible' : ''}`} id='header-sticky'>
      <div className='header-sticky__inner container'>
        <div className='header-sticky__box'>
          <button type='button' ref={triggerRef} className='header-sticky__hamburger category-menu-trigger' aria-haspopup='true' aria-expanded={isMenuOpen} aria-controls='category-menu' onClick={onToggleMenu}>
        ...
        <form className='header-sticky__search' role='search' action='/search'>
          ...
          <input type='search' id='header-sticky-search' name='q' className='header-sticky__search-input' placeholder='도서명, 저자명, 카드번호를 검색해 보세요' />
